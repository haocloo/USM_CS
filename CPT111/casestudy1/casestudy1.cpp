...
int main(){
    ...
    //interchange length and width values to make sure length is longer
    ...
    //to compare decimal values, we need to "remove" the random numbers generated behind the decimal numbers
    largest_length = round(largest_length * 1000.0) / 1000.0;
    largest_width = round(largest_width * 1000.0) / 1000.0;

    //top 2 tables with largest suitable length and width
